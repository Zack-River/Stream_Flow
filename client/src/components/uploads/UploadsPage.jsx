...
// No need for EditableSongCard anymore - SongCard handles edit mode directly
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-4">
            <div className="flex items-center space-x-3">
              ...
              <p className="text-purple-800 dark:text-purple-300 font-medium">
                Edit mode enabled. Hover over songs and click the edit button to modify their details.
              </p>
            </div>
          </div>
        )}
